...
define('js/shake/index',['require','jquery','bootstrap','velocity','shake','components/howler.js/howler.min','js/alertify','underscore','multiline','backbone/backbone','js/shake/token'],function(require) {
    require("jquery");
    require("bootstrap");
    require("velocity");
    require("shake");
