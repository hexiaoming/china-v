...
(function (global, undefined) {
	...
	if (typeof define === "function") {
		define('js/alertify',[], function () { return new Alertify(); });
...
define('js/shake/token',[],function() {
...
define('js/shake/index',['require','jquery','bootstrap','velocity','shake','juicer','components/howler.js/howler.min','js/alertify','underscore','multiline','backbone/backbone','js/shake/token'],function(require) {
    require("jquery");
    require("bootstrap");
    require("velocity");
    require("shake");
